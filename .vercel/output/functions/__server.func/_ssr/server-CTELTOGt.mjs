...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-CTELTOGt.js
var server_CTELTOGt_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BsVoW-Xp.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-YfaUB1VU.mjs").then((n) => n.t),
		import("./start-CpFghQYB.mjs"),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_CTELTOGt_exports as t };
