...
var services = { ["ssr"]: lazyService(() => import("./_ssr/ssr.mjs").then((n) => n.g)) };
...
var _lazy_nUHDKU = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_nUHDKU
	};
	return ((_m, p) => {
		return {
			data,
